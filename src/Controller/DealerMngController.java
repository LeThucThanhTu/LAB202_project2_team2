                ...
                addView.addAddButtonListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        ...
                        if (!valid)
                            ...
                            // Validating input
                            if (!MyTool.validStr(data.get(0), Dealer.ID_FORMAT))
                ...
                updateView.addUpdateButton(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        if (data.equals(""))
                            ...
                            if (d.getName().equals("") || d.getAddr().equals("") || d.getPhone().equals("")
                                    || (d.getContinuing() + "").equals("")) {
                                updateView.showMessage("Please fill in all fields!"); // check empty field
                            } else if (MyTool.validStr(d.getPhone(), Dealer.PHONE_FORMAT))
                                updateView.showMessage("Invalid phone number format!"); // check valid new phone number
                            else {
                                // check update successfully or not
                                if (!dealerDAO.update(d))
                                    updateView.showMessage("Update Dealer Failed: Dealer is not found!");
                                else {
